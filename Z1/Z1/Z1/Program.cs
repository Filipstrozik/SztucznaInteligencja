...
public class Program
{
    public static void Main()
    {
        ...
        RunAlgorithmsBenchmark(g, "Jaworowa", "Perzowa", TimeSpan.Parse("12:30:00"));
        ...
        Console.WriteLine("07:30:00");
        //RunAlgorithmsBenchmark(g, "LEŚNICA", "KSIĘŻE MAŁE", TimeSpan.Parse("07:30:00"));
        Console.WriteLine("07:50:00");
        //RunAlgorithmsBenchmark(g, "LEŚNICA", "KSIĘŻE MAŁE", TimeSpan.Parse("07:50:00"));
